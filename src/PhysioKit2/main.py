...
class physManager(QWidget):
    ...
    #     if args_parser.expConfig:
    #         self.load_exp_params_from_path(args_parser.expConfig)
    
    # def load_exp_params_from_path(self, path):
    #     self.ui.label_params_file.setText(os.path.basename(path))
    ...
    #         return
    #     self.load_exp_params_dict(self.ui.params_dict)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default=files('PhysioKit2.configs.avr_default').joinpath('sw_config.json'), type=str, dest='config', help='Configuration file path.')
    parser.add_argument('--expConfig', default=files('PhysioKit2.configs').joinpath('exp_config_PPG1_PPG2.json'), type=str, dest='expConfig', help='Experiment Configuration file path.')
